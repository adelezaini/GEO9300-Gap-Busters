...
def split_train_test_dataset(original_X, original_y):
    ...
    y_test = original_y[LE_gaps['LE_gaps'].isnull()]
...
def machine_learning_method(algorithm):
    ...
    if algorithm == 'linear_regression':
        ...
        RF_best_model, RF_best_params = model_tuning_CV(X_train, y_train, rf_model, param_grid_rf, cv, CV_scoring)
        ...
        NN_best_model, NN_best_params = model_tuning_CV(X_train, y_train, keras_model, param_grid_nn, cv, CV_scoring)
        ...
        LSTM_best_model, LSTM_best_params = model_tuning_CV(X_train, y_train, lstm_model, param_grid_lstm, cv, CV_scoring)
